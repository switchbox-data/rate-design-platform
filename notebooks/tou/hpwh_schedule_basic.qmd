...
This section defines all variables, parameters, and their temporal dimensions used throughout the decision model. Special attention is given to clarifying the time granularity: while OCHRE operates at 15-minute intervals, consumer decisions occur monthly, and all cost calculations are performed over monthly billing periods (typically 720-744 hours).

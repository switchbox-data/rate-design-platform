...
so the pattern mirrors adjust_mf_electricity.py and approximate_non_hp_load.py.
"""

from data.resstock.assign_utility_ny import assign_utility_ny, read_csv_to_gdf_from_s3
from data.resstock.assign_utility_ri import assign_utility_ri

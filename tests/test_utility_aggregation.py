...
from rate_design.ny.hp_rates.scripts.aggregate_utility_loads import (
...
def test_utility_zone_mapping_structure():
    ...
    expected_utilities = ["NYSEG", "RG&E", "Central Hudson", "National Grid"]
...
def test_utility_zone_mapping_no_overlap_single_utility():
    ...
    ch_zones = UTILITY_ZONE_MAPPING["Central Hudson"]
...
def test_aggregate_utility_load_single_zone():
    ...
    utility_df = aggregate_utility_load(zone_df, "Central Hudson", zones)
    ...
    # Check utility name
    assert utility_df["utility"].unique().to_list() == ["Central Hudson"]
...
def test_aggregate_utility_load_multiple_zones():
    ...
    utility_df = aggregate_utility_load(zone_df, "RG&E", zones)
...
def test_zone_coverage():
    ...
    all_nyiso_zones = ["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K"]

...
| **`data/fred/cpi/`**                | FRED CPI series; Justfile fetch-cpi (local parquet/), upload (sync to s3://data.sb/fred/cpi/), update (fetch-cpi then upload).                                                                                                                                                                                                                                |
...
| **`data/resstock/`**                | ResStock metadata: identify HP customers, heating type, assign_utility_ny (NY). Justfile for fetch, test-download, resstock-identify-hp-customers, assign-utility-ny. Invoked from rate_design/{ny,ri}/hp_rates/Justfile.                                                                                                                                     |

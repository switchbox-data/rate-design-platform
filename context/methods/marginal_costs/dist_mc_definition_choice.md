...
| CL&P MCOS-2 Table 3 (CT, system-wide diluted) | 20.17            | 2026      | FLIC-like (diluted by expansion-area load share) | upstream distribution (station + trunkline) | [exhibit_clp_mcos_2.md](../../sources/mcos/exhibit_clp_mcos_2.md) Table 3; [ct_eversource_dist_mc_methodology.md](ct_eversource_dist_mc_methodology.md) §2                                                                      |
| CL&P MCOS-2 Table 3 (CT, locational)          | 86.58            | 2026      | AIC-like (undiluted, expansion areas only)       | upstream distribution (station + trunkline) | [exhibit_clp_mcos_2.md](../../sources/mcos/exhibit_clp_mcos_2.md) Table 3; [ct_eversource_dist_mc_methodology.md](ct_eversource_dist_mc_methodology.md) §2                                                                      |

Note the pattern: **every figure except NY's and CT's is an avoided/AIC number**, and they cluster at
`$25–80/kW-yr` for distribution alone (E3 is higher because it bundles FERC transmission). NY's FLIC
values are the outlier in magnitude — by construction (§1). CT's system-wide diluted figure
(`$20.17`) is a coincidental exception: it's built the same way as FLIC (locational cost diluted by
load share) but happens to land in the AIC/avoided-cost dollar range because CL&P's undiluted
locational figure (`$86.58`) is itself much larger than NY's undiluted MCOS figures.

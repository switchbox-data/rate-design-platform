...
**Data sources:** Genability tariff JSON at `rate_design/hp_rates/ri/config/tariffs/electric/genability/rie_default.json`; RI PUC compliance filings (e.g. Dockets 25-03-EL, 25-04-EL, 25-05-EL); [tariff-fetch RIE residential A-16 wiki](https://github.com/switchbox-data/tariff_fetch/blob/main/docs/wiki/utilities/rie/residential-a16/index.md).

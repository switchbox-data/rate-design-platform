...
Each variant is exported in both annualized (year-by-year) and levelized form — 8 CSVs per utility. See `context/methods/marginal_costs/ny_mcos_studies_comparison.md` §6 for the rationale behind cumulative vs. incremental and the BAT's preference for incremental.

...
| Output                                        | Description                                         |
| --------------------------------------------- | --------------------------------------------------- |
| `cenhud_cumulative_diluted_levelized.csv`     | One row per bucket: levelized and final-year MC     |
| `cenhud_cumulative_diluted_annualized.csv`    | One row per year, columns per bucket (nominal/real) |
